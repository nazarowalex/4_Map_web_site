    ...
    <div className="layer-ui">
      ...
      >
        ...
        <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
          <path
            d="M12 3 2 9l10 6 10-6-10-6Zm0 9L2 6v4l10 6 10-6V6l-10 6Zm0 5L2 11v4l10 6 10-6v-4l-10 6Z"
            fill="currentColor"
          />
        </svg>
      </button>
      ...
      {open && (
        <div className="layer-menu" role="dialog" aria-label="Map layers">
          ...
          <div className="layer-menu-section">
            {[
              ["osm", "OpenStreetMap"],
          ...
          <div className="layer-menu-section">
            <div className="layer-menu-subtitle">Overlays</div>
            ...
            <label className="layer-item">
              <input
                type="checkbox"
                checked={showSeamarks || baseMap === "nautical"}
...
export default function LeafletMap() {
  const [baseMap, setBaseMap] = useState<"osm" | "cartoLight" | "cartoDark" | "esriSat" | "openTopo" | "nautical">("osm");
